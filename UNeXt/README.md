...
1. Train the model.
```
python train.py --dataset eyebowl --num_classes 2 --arch UNext --name exp11 --img_ext .png --mask_ext .png --lr 0.0001 --epochs 500 --input_w 512 --input_h 512 --b 8
```
2. Evaluate.
```
python val.py --name exp11
```
